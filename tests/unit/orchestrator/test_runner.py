...
from mobius.core.worktree import TaskWorkspace
...
from mobius.orchestrator.parallel_executor import ACExecutionResult, ParallelExecutionResult
...
class TestOrchestratorRunner:
    ...
    async def test_execute_seed_session_creation_failure_releases_workspace_lock(
        ...
        with (
            ...
            patch("mobius.orchestrator.runner.release_lock") as release_lock_mock,
        ):
            result = await runner.execute_seed(sample_seed)
    ...
    async def test_execute_parallel_passes_staged_execution_plan(
        ...
        from mobius.orchestrator.mcp_tools import assemble_session_tool_catalog
        ...
        with (
            patch(
                "mobius.orchestrator.dependency_analyzer.DependencyAnalyzer.analyze",
            ...
            patch(
                "mobius.orchestrator.parallel_executor.ParallelACExecutor.execute_parallel",
    ...
    async def test_execute_parallel_passes_inherited_runtime_handle_to_executor(
        ...
        with (
            ...
            patch(
                "mobius.orchestrator.parallel_executor.ParallelACExecutor",
...
class TestOrchestratorRunnerWithMCP:
    ...
    async def test_get_merged_tools_without_mcp(
        ...
        from mobius.orchestrator.adapter import DEFAULT_TOOLS
...
class TestCancellationPolling:
    ...
    async def test_check_cancellation_returns_true_when_event_exists(
        ...
        from mobius.orchestrator.events import create_session_cancelled_event
    ...
    async def test_execute_seed_stops_on_cancellation(
        ...
        from mobius.core.types import Result
        from mobius.orchestrator.events import create_session_cancelled_event
        from mobius.orchestrator.runner import CANCELLATION_CHECK_INTERVAL
...
class TestCancellationRegistry:
    ...
    async def test_clear_cancellation_is_idempotent(self) -> None:
        ...
        from mobius.orchestrator.runner import clear_cancellation
...
class TestExecutionCancelledError:
    ...
    def test_create_with_defaults(self) -> None:
        ...
        from mobius.orchestrator.runner import ExecutionCancelledError
