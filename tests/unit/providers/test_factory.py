...
class TestResolveLLMBackend:
    ...
    def test_falls_back_to_configured_backend(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr("mobius.providers.factory.get_llm_backend", lambda: "openai")
...
class TestCreateLLMAdapter:
    ...
    def test_creates_codex_adapter_uses_configured_cli_path(
        ...
        monkeypatch.setattr("mobius.providers.factory.get_codex_cli_path", lambda: "/tmp/codex")
    ...
    def test_creates_opencode_adapter_uses_configured_cli_path(
        ...
        monkeypatch.setattr(
            "mobius.providers.factory.get_opencode_cli_path",
            lambda: "/tmp/opencode",
        )
    ...
    def test_uses_configured_opencode_backend_alias_when_backend_omitted(
        ...
        monkeypatch.setattr("mobius.providers.factory.get_llm_backend", lambda: "opencode_cli")
        monkeypatch.setattr(
            "mobius.providers.factory.get_llm_permission_mode",
