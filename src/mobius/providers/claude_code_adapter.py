...
Custom CLI Path:
    ...
    Set via constructor parameter or environment variable:
        ...
        # or
        export MOBIUS_CLI_PATH=/path/to/claude
"""
...
class ClaudeCodeAdapter:
    ...
    def __init__(
        ...
        Args:
            ...
            cli_path: Path to the Claude CLI binary. If not provided,
                checks MOBIUS_CLI_PATH env var, then falls back to
                SDK's bundled CLI.
    ...
    def _resolve_cli_path(self, cli_path: str | Path | None) -> Path | None:
        ...
        Priority:
            ...
            2. MOBIUS_CLI_PATH environment variable
        ...
        if cli_path:
            ...
            from mobius.config import get_cli_path
