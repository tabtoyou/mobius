...
from mobius.core.worktree import TaskWorkspace, heartbeat_lock, release_lock
...
from mobius.orchestrator.execution_strategy import ExecutionStrategy, get_strategy
...
from mobius.orchestrator.runtime_message_projection import (
    message_tool_input,
    message_tool_name,
...
from mobius.orchestrator.workflow_state import coerce_ac_marker_update
...
class OrchestratorError(MobiusError):
    """Error during orchestrator execution."""

    pass


class ExecutionCancelledError(MobiusError):
...
def build_system_prompt(
    ...
    """
    from mobius.orchestrator.workflow_state import get_ac_tracking_prompt
...
class OrchestratorRunner:
    ...
    def _register_session(self, execution_id: str, session_id: str) -> None:
        ...
        """
        from mobius.orchestrator.heartbeat import acquire as acquire_lock
    ...
    def _unregister_session(self, execution_id: str, session_id: str) -> None:
        ...
        """
        from mobius.orchestrator.heartbeat import release as release_lock
    ...
    async def execute_precreated_session(
        ...
        from mobius.observability.logging import set_console_logging
        ...
        try:
            ...
            from mobius.orchestrator.workflow_state import WorkflowStateTracker
    ...
    async def _execute_parallel(
        ...
        Returns:
            Result containing OrchestratorResult on success.
        """
        from mobius.orchestrator.dependency_analyzer import ACNode, DependencyAnalyzer
        ...
        if dep_result.is_err:
            ...
            from mobius.orchestrator.dependency_analyzer import DependencyGraph
