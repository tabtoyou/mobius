...
This is where the Mobius eats its tail: the output of evaluation becomes
...
from mobius.config import get_reflect_model
from mobius.core.errors import ProviderError
from mobius.core.lineage import EvaluationSummary, MutationAction, OntologyDelta, OntologyLineage
...
class ReflectEngine:
    ...
    This is where the Mobius eats its tail:
    ...
    def _system_prompt(self) -> str:
        return """You are the Reflect Engine of Mobius, an evolutionary development system.
